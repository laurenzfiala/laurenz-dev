import { Content, paragraph, section, timeline } from '../../app/content';
import { CvEntryDetailsEnvironment } from '../../app/cv/cv-entry-details/cv-entry-details';
...
export default [
  ...
  section(),
  paragraph(`
  Tech/Tools used: Vue, Typescript, JavaScript, Storybook, SCSS, Playwright, Jest, Typo3, Sentry.
  `),
